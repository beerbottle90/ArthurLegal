...
ÖTV Kanunu'nda **4 sayılı liste** var. [RAFİNERİ] için:

- **(I) sayılı liste:** Petrol ürünleri, motor yağları, doğal gaz — **[RAFİNERİ]'ın ana alanı**
...
```
Ham petrol alım ([Ana ortak / ilişkili taraf]) →
Rafineriye giriş →
...
tr_ictihat_ara(
  ...
  chamber="D3",
  query="+ÖTV +mahsup +akaryakıt +ihracat +istisna +rafineri",
  date_from="2022-01-01"
)

tr_kurum_karari_ara(
  kurum="gib",
  query="ÖTV mahsup rafineri"
)
```
...
```
tr_mevzuat_ara(number="4760", types=["KANUN"])  # ÖTV K.
tr_mevzuat_ara(number="5015", types=["KANUN"])  # Petrol Piyasası K.
```
...
- [ArthurLegal MCP TR mevzuat rehberi](mevzuat-mcp-rehberi.md)
- Büro profili → tax-legal ([RAFİNERİ] ÖTV stres alanı)
