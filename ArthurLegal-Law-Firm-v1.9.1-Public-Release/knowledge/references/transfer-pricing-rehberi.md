# Transfer Pricing Rehberi — [Ana ortak / ilişkili taraf] Intra-Group

> KVK m. 13 + OECD TPG. [Müvekkil]'nin ana ortağı ([ANA ORTAK MERKEZİ]) ile yaptığı intra-group işlemler Maliye için en hassas alanlardan biri.
...
## [Müvekkil]-özel TP haritası

### Ham petrol alımı ([Ana ortak / ilişkili taraf] → [RAFİNERİ])
...
- **[Müvekkil] brand royalty** — BEPS Action 8 (intangibles) hassas
...
→ Bu **[Müvekkil] ([ANA ORTAK MERKEZİ]) ana şirket tarafından hazırlanır** (yurt dışında merkezdir).
...
→ Türkiye'de [Müvekkil] + Büyük 4 firma birlikte hazırlar.

### CbCR (Country-by-Country Reporting)
- Konsolide grup ana şirket ([Ana ortak / ilişkili taraf]) hazırlar
- Türkiye yetkilisi: GİB (Yetkili Otorite — Türkiye ile karşı devlet arası bilgi paylaşımı)
...
6. **Loss-making entity:** [Müvekkil] sürekli zarar ediyorsa intra-group fiyat sorgulanır

## Savunma araçları

- **APA (Advanced Pricing Agreement)** — Maliye ile peşin fiyat anlaşması. Türkiye'de süreç yavaş ama uygun.
- **MAP (Mutual Agreement Procedure)** — Çifte vergilendirme yaşandıysa, Türkiye ile karşı devletin yetkili makamları görüşmesi.
- **Cost contribution arrangements** — Ortak fayda projeleri için (R&D, IT)
- **Cost sharing agreement** — Maliyet bölüşüm

## ArthurLegal MCP (`tr_`) — TP içtihatı

```
tr_kurum_karari_ara(
  kurum="gib",
  query="transfer fiyatlandırma örtülü kazanç ham petrol"
)

tr_ictihat_ara(
  courts=["DANISTAYKARAR"],
  chamber="D4",
  query="+KVK +13 +transfer +pricing +emsal +fiyat",
...
```
tr_mevzuat_ara(number="5520", types=["KANUN"])  # KVK
```
...
- Büro profili → tax-legal (bu plugin)
