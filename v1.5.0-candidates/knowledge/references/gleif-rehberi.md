...
Senaryo: sözleşme karşı tarafı "[ŞİRKET ADI]" — kimlik sabitle, nihai ana
ortağı bul, sonra yaptırım taramasına geç.

```
ADIM 1 — Unvandan LEI bul:
  WebFetch: https://api.gleif.org/api/v1/autocompletions?field=fulltext&q=[ŞİRKET ADI]
  → "[ŞİRKET ADI] A.Ş." — LEI: [LEI]

ADIM 2 — Kaydı doğrula:
  WebFetch: https://api.gleif.org/api/v1/lei-records/[LEI]
  → jurisdiction: TR, legalAddress: İstanbul, registration.status: ISSUED

ADIM 3 — Nihai ana ortak (Level 2):
  WebFetch: https://api.gleif.org/api/v1/lei-records/[LEI]/ultimate-parent
  → "Azərbaycan Dövlət Neft Şirkəti" (State Oil Company of Azerbaijan Republic)
    LEI: [ANA ORTAK LEI], jurisdiction: [ÜLKE]
...
ADIM 5 — Atıf:
  [GLEIF — LEI [LEI] — çekim: 13.08.2026]
```
...
ADIM 1 — Unvan filtresi:
  ...
  → [GRUP ŞİRKETİ 1] ([ÜLKE]), [GRUP ŞİRKETİ 2] ([ÜLKE]), [GRUP ŞİRKETİ 3] ([ÜLKE]),
    [GRUP ŞİRKETİ 4] ([ÜLKE]), [GRUP ŞİRKETİ 5] ([ÜLKE])
...
```
[GLEIF — LEI [LEI] — çekim: 13.08.2026]
[GLEIF — ultimate-parent: [ANA ORTAK LEI] — çekim: 13.08.2026]
```
