...
1. **ArthurLegal MCP (`tr_`)** üzerinden anahtar kelimelerle tara:
...
2. **ArthurLegal MCP (`tr_`)** üzerinden ilgili kanun/yönetmelik değişikliklerini tara.
...
🔴 [ArthurLegal TR — Yargıtay HGK — E. 2025/… K. 2026/… — GG.AA.YYYY]
   Özet: …
   Etkilediği çalışmanız: "…" (2024), s. 45'teki argüman
   Yapılacak: …

⚠️ Kapsam beyanı
Taranan: ArthurLegal MCP (`tr_`) (Yargıtay/Danıştay/AYM/Emsal), ArthurLegal MCP (`tr_`)
