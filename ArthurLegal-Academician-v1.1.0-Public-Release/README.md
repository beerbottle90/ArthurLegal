...
**Sürüm:** v1.1.0 · **Tarih:** 2026-09-23 · **Lisans:** Proprietary — Non-Commercial (bkz. [LICENSE](LICENSE))
**Hedef ortam:** [Claude.ai Projects](https://claude.ai/projects) (web)

> **v1.1.0 — 8 plugin · 28 skill · 24 referans · 4 agent.** Tam iki dilli (TR + EN),
...
| Sunucu | Kapsam |
|---|---|
| ArthurLegal MCP (`tr_`, auth yok) | TR mevzuat + gerekçe + Yargıtay / Danıştay / AYM + Resmî Gazete + 8 düzenleyici kurum + semantik arşiv; `scholar_` ile DergiPark doktrini |
| ArthurLegal MCP (`tkgm_`, aynı uç) | Tapu-kadastro: TKGM Parsel Sorgu'dan canlı parsel, parsel raporu, ölçekli kroki (bilgi amaçlı) |
...
**Version:** v1.1.0 · **Date:** 2026-09-23 · **License:** Proprietary — Non-Commercial (see [LICENSE](LICENSE))
...
**Connected MCP servers:** ArthurLegal MCP (`tr_`: Turkish legislation and case law, plus 14 jurisdictions and DergiPark scholarship) · CourtListener
