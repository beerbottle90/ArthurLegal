...
**MCP:** ArthurLegal MCP — Türkiye backend'i [`arthur-tr-hukuk-mcp`](https://github.com/beerbottle90/arthurlegal-mcp/tree/master/arthur-tr-hukuk-mcp) (MIT; uç bilgisi [saidsurucu](https://github.com/saidsurucu)'nun yargi-mcp ve mevzuat-mcp projelerinden) · CourtListener (Free Law Project) · Fedlex ·
