...
yaptırımlarını yönetir. [Müvekkil] ticaret birimi karşı taraf taramasında kritik.
...
## 4. [Müvekkil] ticaret birimi için tipik kullanım pattern'ları
...
- `yaptirim-tarama-rehberi.md` — [Müvekkil] yaptırım prosedürü
