...
|---|---|---|
| **EPDK** | https://www.epdk.gov.tr/Detay/Icerik/3-0-0-94/karar-tarihi | Petrol, doğal gaz, elektrik ([HALKA AÇIK İŞTİRAK], STAR, [ELEKTRİK SANTRALİ], dağıtım) — **kritik** |
...
- 🔴 **EPDK kurul kararları** ([HALKA AÇIK İŞTİRAK]/STAR/[ELEKTRİK SANTRALİ] lisansları, doğal gaz pazar dengesi)
