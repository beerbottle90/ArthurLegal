...
> **Auth:** Yok
> **⚠️ 2026-06-28 testi:** `gesetze-im-internet.de` bu ortamdan **ECONNREFUSED** (erişilemiyor). **Birincil alternatif → NeuRIS API:** `https://testphase.rechtsinformationen.bund.de/v1/legislation` (JSON, auth yok, ✅ test edildi). İkincil: `offenegesetze.de` (2023'te donduruldu — arşiv).
