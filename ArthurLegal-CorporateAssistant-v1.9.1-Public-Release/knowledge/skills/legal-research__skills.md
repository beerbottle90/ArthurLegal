...
- **Tipik tetikleyiciler:** Azerbaycanlı karşı taraflarla işlemler (ham petrol
  tedarik, royalty, transfer fiyatlandırması, JV), Azerbaycan'da istihdam edilen
  personel için iş hukuku, ortak girişim yapıları, [ŞİRKET ADI] ile
  Azerbaycanlı taraf arasındaki sözleşmelerde uygulanacak hukuk seçimi.
