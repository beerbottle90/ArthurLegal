...
> **[ŞİRKET ADI] neden gerekli?** [ANA ORTAK] ile intra-group işlemler (ham petrol tedarik,
> royalty, transfer fiyatlandırması, JV), 200+ Azerbaycanlı çalışan için iş hukuku,
> [ŞİRKET ADI] Turkey ile [ŞİRKET ADI] [ANA ORTAK MERKEZİ] arasındaki sözleşmelerde uygulanacak hukuk seçimi
...
| minenergy.gov.az/en/qanunlar | WebFetch | Enerji sektörü kanunları | EN + AZ | P0 — [ŞİRKET ADI] odağı |
