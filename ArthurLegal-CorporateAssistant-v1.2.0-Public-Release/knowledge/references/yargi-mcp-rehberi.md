...
| **[HALKA AÇIK İŞTİRAK] SPK davaları** | Danıştay 13. ve 10. Daire kararları (SPK düzenlemelerine itiraz) |
...
| **GİB transfer pricing özelge** | Vergi konularında [ANA ORTAK] işlemleri için |
...
[ÖZEL ENDÜSTRİ BÖLGESİ] / [ŞİRKET ADI] dikey yapısı emsali.
...
[İLİŞKİLİ TARAF] → [RAFİNERİ] ham petrol alım fiyat denetimi için.
...
[ELEKTRİK SANTRALİ] gibi enerji ihaleleri.
...
## [ŞİRKET ADI] Yarg MCP kullanım disiplini

1. **[HALKA AÇIK İŞTİRAK]/EPDK/Rekabet kararları** araştırırken → Yarg MCP birinci kaynak
2. **İş hukuku davaları** ([İşletme Yeri] kazaları, fesih, kıdem) → Yargıtay 9./22./4./12. HD
