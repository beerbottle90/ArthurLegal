...
## ⚠️ İnceleyen notu
- **İade tipi:** [HALKA AÇIK İŞTİRAK] KDV / STAR ÖTV / Diğer
- **Aşama:** A/B/C/D
- **Beklenen tutar:** [TL]
...
|---|---|---|---|---|
| [ŞİRKET ADI] (Bakü) | Ham petrol satın alım | [...] | USD | sürekli |
...
- **Country-by-Country Reporting (CbCR)** — global [ŞİRKET ADI] (Bakü ana şirket tarafından)
...
- [ ] **STAR ÖTV / [HALKA AÇIK İŞTİRAK] KDV iade reddi** → kaza-bazlı dava + uzlaşma kombinasyonu
