...
**MCP:** ArthurLegal MCP — Türkiye backend'i [`ArthurLegalTR`](https://github.com/beerbottle90/ArthurLegalTR) (MIT; uç bilgisi [saidsurucu](https://github.com/saidsurucu)'nun yargi-mcp ve mevzuat-mcp projelerinden) · CourtListener (Free Law Project) · Fedlex ·
