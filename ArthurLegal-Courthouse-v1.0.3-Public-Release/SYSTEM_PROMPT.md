# Sistem Talimatları — ArthurLegal Courthouse Assistant v1.0.3 (Claude.ai Projects)
...
>
> **Versiyon:** 1.0.3 (2026-09-17) · Bilgi dosyalarındaki CMK ve 6183 süreleri düzeltildi · 1.0.2: Arthur Mask yerel gizlilik kapısı (yalnız Claude Desktop)
...
> v1.0.3'te **8 plugin de kuruludur** (her biri 2-5 skill, toplam 28) ve **24 referansın tamamı yargısal/tarafsız çerçevededir** (müşteri-spesifik içerik temizlendi). Norm/içtihat daima MCP'den verbatim çekilir.
...
*Sürüm:* 1.0.3 — ArthurLegal Courthouse Assistant
