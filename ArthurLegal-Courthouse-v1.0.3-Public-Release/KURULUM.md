...
Bu sürüm **v1.0.3**'tür. v1.0.2'den geçiş: yalnız bilgi dosyaları değişti (CMK ve 6183 süreleri). Project knowledge'da şu beş dosyayı yenileyin: `knowledge/references/cmk-rehberi.md`, `knowledge/references/sulh-ceza-hakimligi-rehberi.md`, `knowledge/references/vergi-yargisi-rehberi.md`, `knowledge/skills/ceza-kalem__skills.md`, `knowledge/skills/vergi-hakim__skills.md`. `SYSTEM_PROMPT.md` yalnız sürüm etiketinde değişti; yeniden yapıştırmak zorunlu değil.

v1.0.1'den geçiş (v1.0.2): `SYSTEM_PROMPT.md` yeniden yapıştırılır (yeni Arthur Mask bölümü); `knowledge/references/arthur-mask-rehberi.md` Project knowledge'a eklenir. Arthur Mask kullanacaksanız yukarıdaki adımları uygulayın ve Project'i Claude Desktop'tan açın. Değişiklikler: [CHANGELOG.md](CHANGELOG.md).
