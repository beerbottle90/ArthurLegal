...
```
~/.claude/plugins/config/claude-for-legal-law-firm/pre-matter/<YYYYMMDD>__<müvekkil-kod>/
```
...
**Gerçek kişi:**
- Kod adı (kayıt için — gerçek isim KVKK uyarınca minimum)
...
**Tüzel kişi:**
- Ünvan (kısaltılmış kod adı da OK ama tam ünvanı sonradan kayda al)
- Vergi no + MERSİS no
- Faaliyet alanı (NACE)
...
- Karşı taraf var mı? (varsa: kim — kod adı + tüzel kişi tipi)
...
# Müvekkil Intake — [Kod adı] — [Tarih]

## ⚠️ İnceleyen notu
- Pre-matter klasörü: pre-matter/[YYYYMMDD]__[kod]/
- Aciliyet: 🔴/🟠/🟢
...
- **Müvekkilin gerçek ismini intake notuna yazma** — kod adı kullan (gerçek isim MASAK + KVKK kontrolünden sonra sadece matter dosyasında)
