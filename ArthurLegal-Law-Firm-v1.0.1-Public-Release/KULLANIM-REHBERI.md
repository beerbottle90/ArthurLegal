...
**Yer-tutucu yapı:** Tüm gerçek-kişi/müvekkil isimleri rol-bazlı (`[Yönetici Ortak]`, `[Kıdemli Ortak A]`, `[Müvekkil kod adı]`, `[KOBİ Üretici]` vb.) tutulmuştur. Büro örneği (`ArthurLegal Hukuk Bürosu`) tamamen kurgusaldır.
...
> ⚠️ **MESLEKİ SIR UYARISI:** `firm-profile.md`'ye gerçek müvekkil isimleri YAZMAYIN. Müvekkil portföyü **agregat sektör/tip/coğrafya** olarak tutulur. Matter-spesifik bilgi her matter için ayrı çalışmada — Claude.ai Projects'te müvekkil kod adı (`[Müvekkil-001]`, `[KOBİ Üretici]`) kullanın.
...
Karşı taraf: kod adı "Tedarikçi-X" (KOBİ, gıda ambalaj)
...
Müvekkil: [yeni gelen müvekkilin TC/Vergi no maskelenmiş]
Karşı taraf: Tedarikçi-X (Vergi no maskelenmiş)
...
- **Anonimleştirme:** Müvekkil + karşı yan + tanık isimlerini **kod adı** ile değiştirin. "X" + "Y" yeterli.
