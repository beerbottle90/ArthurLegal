...
> **Multi-jurisdiction legal assistant package for in-house corporate legal teams**, built on Claude and packaged as a Claude.ai Projects bundle — `SYSTEM_PROMPT.md` + 66 knowledge files + up to 7 MCP connectors, covering **28 jurisdictions**.
>
