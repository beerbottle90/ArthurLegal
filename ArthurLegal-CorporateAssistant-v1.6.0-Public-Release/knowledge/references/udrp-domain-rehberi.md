...
> [ŞİRKET ADI]/[HALKA AÇIK İŞTİRAK]/[RAFİNERİ] markalarını taklit eden sahte domain'ler için müdahale prosedürü. `sahte-domain-ornegi.com` benzeri vakalar — test v1.3.0 Q12 ile tespit edildi.

## 3 paralel müdahale kanalı

Sahte domain (örn. `sahte-domain-ornegi.com`) tespit edildiğinde **3 ayrı hukuki rejim** paralel işler:
...
#### Resmi açıklama
- [ŞİRKET ADI] resmi web + sosyal medya: "Bu site [ŞİRKET ADI] ile bağlantılı değildir. Resmi bayilerimiz sirket.com.tr'den teyit edilebilir. Ödeme YAPMAYIN."
...
**`sahte-domain-ornegi.com` örneği:** Hepsi sağlanır — kazanma olasılığı %90+
...
- **Domain taraması:** `sirket-*`, `*-sirket-*`, `[petrokimya iştiraki]-*`, `rafineri-*` pattern'larında
...
- Anahtar varyantlar [ŞİRKET ADI] adına alın (defensive):
  - `sahte-domain-ornegi.com.tr`, `.com`, `.net`, `.org`, `.eu`
