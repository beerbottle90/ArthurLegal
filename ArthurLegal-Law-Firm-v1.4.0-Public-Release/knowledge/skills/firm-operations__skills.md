...
- Yönetici Ortak (kod adı + baro/sicil + uzmanlık)
...
- **Müvekkil isim/şirket isteyebilir** → "ASLA gerçek müvekkil ismi yazmayın. Kod adı/agregat kullanın."
...
# Conflict Check — [Müvekkil kod adı] vs. [Karşı yan kod adı]
Tarih: GG.AA.YYYY
...
- **Müvekkilin gerçek ismini intake notuna yazma** — kod adı kullan
