...
|---|---|---|
| **Mevzuat MCP** (TBK + TTK + KEP + DVK + SMK) | ✓ | mevzuat.gov.tr |
...
**Sözleşme özel:**
- **Hiçbir zaman kanun atıfını "hatırlayarak" yazma** — Mevzuat MCP'den çek (TBK/TTK madde no'ları sık değişir).
- **Yargı MCP emsal arama** — özellikle TBK 115 + sorumsuzluk şartı / aksi takdirde / aşırı yararlanma tipi davalarda yeni Yargıtay görüşü kontrol et.
