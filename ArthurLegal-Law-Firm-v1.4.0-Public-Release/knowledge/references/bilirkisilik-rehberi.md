...
> **Durum:** ✅ Açık erişim — API anahtarı gerekmez. Mevzuat (6754 / HMK / CMK) **Mevzuat MCP** ile, içtihat **Yargı MCP** ile çekilir. Bu rehber **expert-opinion** plugin'ini (`bilirkisi-raporu`, `uzman-mutalaasi` skill'leri) destekler. **Asıl kullanım** = karşı taraf/mahkeme bilirkişi raporuna **İTİRAZ** + müvekkil lehine **uzman görüşü (mütalaa)** ürettirme.
