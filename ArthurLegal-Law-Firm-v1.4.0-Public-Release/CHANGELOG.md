...
### Talimat hizalaması — Copilot Studio canonical prompt'u

`copilot-studio-asistani` deposundaki `global-instructions.md`'de bulunup
...
- Bu sürüm `copilot-studio-asistani` deposundaki MCP entegrasyon
