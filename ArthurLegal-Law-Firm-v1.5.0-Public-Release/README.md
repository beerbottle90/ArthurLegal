...
**Version:** v1.5.0 · **Date:** 2026-08-29 · **License:** Proprietary — Non-Commercial (see [LICENSE](LICENSE))
**Target environment:** [Claude.ai Projects](https://claude.ai/projects) (web)

> **Multi-jurisdiction legal assistant package for small-to-mid law firms (0–30 staff)**, built on Claude and packaged as a Claude.ai Projects bundle — `SYSTEM_PROMPT.md` + 91 knowledge files + up to 7 MCP connectors, covering **22 jurisdictions**.
>
