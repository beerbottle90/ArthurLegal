...
### Örnek 1: Ham petrol ithalat sözleşmesi ([Ana ortak / ilişkili taraf] → [RAFİNERİ])

**Senaryo:** [Müvekkil] ([RAFİNERİ] adına), yurt dışındaki bir tedarikçiden 200M USD'lik ham petrol alıyor (1 yıllık çerçeve).
...
**Senaryo:** [ELEKTRİK ÜRETİM İŞTİRAKİ], EPİAŞ üzerinden günlük elektrik satışı yapıyor. Sözleşme yapısı: çerçeve EPİAŞ üyelik + günlük teklifler.
