...
**Version:** v1.8.1 · **Date:** 2026-09-17 · **License:** Proprietary — Non-Commercial (see [LICENSE](LICENSE))
...
Version history and the full v1.0.1 → v1.8.1 progression: [CHANGELOG.md](CHANGELOG.md).
...
```
ArthurLegal-Law-Firm-v1.8.1-Public-Release/
