...
> [Müvekkil] için stratejik dava alanlarından biri: tahkim. [BORU HATTI PROJESİ], intra-group [Ana ortak / ilişkili taraf] işlemleri, büyük EPC sözleşmeleri tahkim klozu içerir.
...
## büro pratiği için tahkim klozu önerileri
...
Eğer karşı taraf **geçerli bir tahkim klozu varken mahkemede dava açtıysa**, [Müvekkil]'ın ilk cevap dilekçesinde:
...
tr_ictihat_ara(
  ...
  query="+tahkim +itiraz +mahkeme +görevsizlik",
  chamber="HGK",
...
```
tr_ictihat_ara(
  query="+yabancı +tahkim +karar +tanıma +tenfiz +New +York",
  date_from="2022-01-01"
)
```
...
### Intra-group [Ana ortak / ilişkili taraf] işlemleri
Transfer pricing, ham petrol alım fiyatlandırması gibi konularda [İLİŞKİLİ TARAF] ile uyuşmazlık çıkması mümkün. Tahkim seçeneği:
- **ISTAC** — TL hukuku
...
[BORU HATTI PROJESİ] Hükümetlerarası Anlaşması (ilgili devletler) + Ev Sahibi Hükümet Anlaşması (HGA) — uluslararası antlaşma rejimi. Uyuşmazlıklar genelde devletler arası arabuluculuk, dış vekil uzman gerek.

## Bağlantılı

- [HMK rehberi](hmk-rehberi.md) — HMK m. 412 vd. tahkim
- İSTAÇ kural metinleri ArthurLegal MCP'de yoktur (istac.org.tr 06.09.2026'da erişilemez); kuralları kurumdan alın, tahkim itirazı ve tenfiz içtihadı için `tr_ictihat_ara`
