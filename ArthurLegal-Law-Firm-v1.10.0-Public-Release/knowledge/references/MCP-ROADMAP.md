...
| MCP | Test | Sonuç |
|---|---|---|
| ArthurLegal MCP `tr_` (TR, 06.09.2026) | `tr_mevzuat_ara(number="6698")` · `tr_ictihat_ara(query="+\"rekabet yasağı\" +\"cezai şart\"")` · `tr_semantik_ara(kurum="bddk", mode="semantic")` | ✅ KVKK · içtihat · 8 kurum, 19.404 belge vektörlü |
| YargiMCP / yargi-mcp-pro (TR, isteğe bağlı) | `mevzuat_no=6698` · `+"rekabet yasağı" +"cezai şart"` | ✅ KVKK + 801 karar (30.08.2026) |
