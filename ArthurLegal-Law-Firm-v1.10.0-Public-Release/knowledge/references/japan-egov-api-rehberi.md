...
GET /keyword?keywords={URL-encoded}      # tam metin anahtar kelime araması
...
```
WebFetch:
  URL: https://laws.e-gov.go.jp/api/2/keyword?keywords=%E9%9B%BB%E6%B0%97%E4%BA%8B%E6%A5%AD&limit=10
