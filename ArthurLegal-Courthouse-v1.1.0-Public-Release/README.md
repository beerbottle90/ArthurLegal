...
> **v1.1.0 — 8/8 plugin kurulu** (her biri 2-5 skill, toplam 28 skill + 25 referans; tapu-kadastro rehberi dâhil). Referansların tamamı yargısal/tarafsız çerçevede (müşteri-spesifik içerik temizlendi).
...
| **ArthurLegal MCP** (`tkgm_`, aynı uç) | Tapu-kadastro: TKGM Parsel Sorgu'dan canlı parsel, parsel raporu, ölçekli kroki, dayanak köprüsü; bilgi amaçlı, bilirkişi ve kadastro kaydı yerine geçmez |
...
```
ArthurLegal-Courthouse-v1.1.0-Public-Release/
...
└── knowledge/             ← Project Knowledge'a yüklenecek dosyalar
    ...
    └── references/             (25 referans: 15 paylaşılan + 7 mahkeme-tarafı + 1 connector-sağlık + 1 Arthur Mask + 1 tapu-kadastro)
```
