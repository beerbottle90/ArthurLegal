...
## [1.1.0] — 2026-09-23 — *Tapu: TKGM Parsel Sorgu'dan Canlı Parsel; Araç Haritası Canlı Uçla Eşitlendi*
...
2. `SYSTEM_PROMPT.md`: "Knowledge'da olmayan bilgi" listesine taşınmaz/parsel satırı (`tkgm_`).
...
3. `gib-ozelge-rehberi.md`, `otv-rehberi.md`: GİB aramasında `phrase` diye süzgeç yoktur; arama metni gitmiyor,
   sonuç süzülmeden dönüyordu. Örnekler `query` ile yazıldı.
