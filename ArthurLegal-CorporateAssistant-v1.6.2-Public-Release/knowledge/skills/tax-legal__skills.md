...
1. **TR Legal MCP** — test: `kurum_karari_ara(kurum="gib", keywords="transfer fiyatlandırma")` → cevap geliyor mu?
...
> C. Diğer ([DAĞITIM İŞTİRAK 1]/[DAĞITIM İŞTİRAK 2] dönemi KDV, vs.)
...
description: >
  Intra-group işlem fiyatlandırması analizi: [ANA ORTAK] ile ham petrol alımı, royalty,
...
1. **Ham petrol alımı ([ANA ORTAK] → [RAFİNERİ])** — yüksek tutar, fiyat dalgalanması (Brent benchmark)
