...
**Pratik:** Bir sözleşmeyi imzalamadan önce DVK (1) ve (2) tablolarına bakmadan "muaf" deme. ArthurLegal MCP (`tr_`)'den `tr_mevzuat_ara(query="488")` ile teyit.
...
- Damga vergisi azami had (her bir kağıt için): [ArthurLegal TR — doğrulayın]
- Genel oran (binde): [ArthurLegal TR — doğrulayın]
- 488 (1) sayılı Tablo güncel tutarları: [ArthurLegal TR — tr_mevzuat_ara("488")]
...
4. **Nispet & nüsha:** İlgili nispet (her yıl RG'de güncel tarife — ArthurLegal MCP (`tr_`) teyidi); nüsha sayısı (DVK m. 5) ve **azami had (DVK m. 14)** doğru uygulanmış mı.
...
> Sonuç (iptal/ret/kısmen iptal) **hâkim/heyet takdiridir**; norm ve tarife **ArthurLegal MCP (`tr_`)'den verbatim** teyit edilir.
