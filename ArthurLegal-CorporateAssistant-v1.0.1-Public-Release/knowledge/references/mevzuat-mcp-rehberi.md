...
- **Yargıtay/Danıştay/AYM kararları** Mevzuat MCP'de YOK — **bunlar için Yargı MCP kullanın** (bkz. `yargi-mcp-rehberi.md`). İkisi tamamlayıcıdır.
- **Kurum kararları (BDDK, SPK, EPDK, KVKK Kurulu) zaman zaman Mevzuat MCP'de eksik** — KVKK Kurulu + BDDK için Yargı MCP daha güçlü; SPK için kurum sitesine + KAP'a fallback; EPDK için kurum sitesi.
...
## Mevzuat MCP + Yargı MCP — birlikte kullan
...
| **Yargı MCP** | Yargıtay, Danıştay, AYM, KVKK Kurulu, Rekabet, KİK, BDDK, GİB, Sayıştay, Sigorta Tahkim, alt mahkemeler — **kararlar/yorumlar** |

Bir hukuki sorgu çoğunlukla ikisini birlikte gerektirir:
1. **Mevzuat MCP**'den ilgili madde + tüm fıkraları getir
2. **Yargı MCP**'den o maddenin yargı/idari yorumunu getir
