# Atıf — ArthurLegal Claude Law Firm Assistant v1.7.0
...
| **Kardeş paket** | ArthurLegal Claude Corporate Assistant v1.7.0 (in-house tarafı; aynı metodoloji) |
...
Bu paket halka açık sürümünde **gerçek kişi/şirket/müvekkil verisi içermez**. Tüm gerçek-kişi isimleri rol-bazlı yer-tutucularla (`[Yönetici Ortak]`, `[Kıdemli Ortak A]`, `[Müvekkil kod adı]`, `[KOBİ Üretici]` vb.) değiştirilmiştir. Büro örneği (`ArthurLegal Hukuk Bürosu`) tamamen kurgusaldır.
