...
Transfer pricing, ham petrol alım fiyatlandırması gibi konularda [ANA ORTAK MERKEZİ] ile uyuşmazlık çıkması mümkün. Tahkim seçeneği:
- **ISTAC** — TL hukuku
- **Stockholm Chamber of Commerce (SCC)** — Azerbaycan tercih ediyor ([ANA ORTAK MERKEZİ]'den uzak ama tarafsız)
