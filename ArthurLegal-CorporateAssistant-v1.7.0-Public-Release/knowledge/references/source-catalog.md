...
| Kurum | Kaynak | Not |
|---|---|---|
| Resmî Gazete | `https://www.resmigazete.gov.tr/` ✅ | Günlük. **ArthurLegal MCP `tr_resmi_gazete_fihrist` ve `tr_resmi_gazete_tara` araçlarını tercih et** — yapılandırılmış döner |
