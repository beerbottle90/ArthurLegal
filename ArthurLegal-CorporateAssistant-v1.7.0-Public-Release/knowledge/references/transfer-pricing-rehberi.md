...
> KVK m. 13 + OECD TPG. [ŞİRKET ADI]'nin ana ortağı ([ANA ORTAK MERKEZİ]) ile yaptığı intra-group işlemler Maliye için en hassas alanlardan biri.
...
### Ham petrol alımı ([İLİŞKİLİ TARAF] → [RAFİNERİ])
...
→ Bu **[ŞİRKET ADI] ([ANA ORTAK MERKEZİ]) ana şirket tarafından hazırlanır** (yurt dışında merkezdir).
