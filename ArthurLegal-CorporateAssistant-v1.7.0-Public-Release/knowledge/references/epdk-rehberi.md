...
> [ŞİRKET ADI] için günlük operasyonel düzenleyici. [RAFİNERİ] (petrol piyasası), [HALKA AÇIK İŞTİRAK] (petrokimya), [ELEKTRİK SANTRALİ] (elektrik üretim), [DAĞITIM İŞTİRAKİ] (doğal gaz dağıtım) — hepsi EPDK lisans + tebliğ kapsamında.

## Hukuki çerçeve

| Kanun | Sektör |
|---|---|
| **5015 Petrol Piyasası Kanunu** | Rafineri, akaryakıt — [RAFİNERİ] + [ŞİRKET ADI] Enerji Ticaret |
