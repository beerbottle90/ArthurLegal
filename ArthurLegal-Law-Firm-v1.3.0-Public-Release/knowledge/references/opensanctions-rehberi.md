...
## [Müvekkil] Türkiye için neden kritik?

[Müvekkil]'ın commercial-legal'da "the thing that hurts" olarak işaretlenen yaptırım taraması, 6 farklı rejimi tek tek tarama gerektiriyordu. OpenSanctions **tek API çağrısı ile 70+ liste** veriyor.
...
[Müvekkil] için: **commercial vendor screening → `default` veya `sanctions`**, PEP'ler counterparty UBO incelemesinde alttan kontrol.

---

## API key prosedürü ([Müvekkil] için)

**Adım 1:** https://www.opensanctions.org/api/ → Sign up

**Adım 2:** İletişim bilgileri + kullanım amacı (commercial screening for [Müvekkil] Türkiye) → ticari ekiple lisans görüşmesi
...
- **Lisans aktif** — [Müvekkil] ticari abonelik (13.05.2026'dan itibaren). Kullanım kotası ve aşım takibi OpenSanctions panelinden izlenir.
...
- **Kalibrasyon yıllık:** match skoru eşikleri [Müvekkil] risk komitesi tarafından yıllık gözden geçirilmeli
