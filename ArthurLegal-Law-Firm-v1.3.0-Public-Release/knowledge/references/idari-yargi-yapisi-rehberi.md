...
### [Müvekkil] için en kritik daireler
...
| **8. Daire** | Belediye / imar / yapı | Aliağa ÖEB bağlantılı yatırımlar |
| **10. Daire** | **Çevre + doğal kaynak** | **Aliağa İSG/çevre cezaları temyiz** — birincil önemli |
| **13. Daire** | **EPDK + Rekabet + BDDK + SPK + KGK + KİK** | **[Müvekkil] için TEMEL** — enerji + finansal düzenleyici |
| **14. Daire** | **ÇED + imar/çevre ek** | **Aliağa ÇED** — birincil |
| **İDDK** | Birleştirici, ısrar incelemesi | Çelişki çözümünde |

### Diğer Danıştay daireleri ([Müvekkil]'da daha az)
...
[Müvekkil] için ana BİM'ler:
- **Ankara BİM** — EPDK/Rekabet/KVKK/KİK kararları (kurumlar Ankara merkez)
- **İzmir BİM** — Aliağa kaynaklı il düzeyi davalar
