...
**Sürüm:** v1.2.0 · **Tarih:** 2026-06-04 · **Lisans:** Proprietary — Non-Commercial (bkz. [LICENSE](LICENSE))
...
>
> *A Turkish-law adaptation of Anthropic's claude-for-legal — packaged as a Claude.ai Projects bundle (SYSTEM_PROMPT + 60+ knowledge files) for small-to-mid (0–30 staff) law firms.*
...
```
ArthurLegal-Law-Firm-v1.2.0-Public-Release/
