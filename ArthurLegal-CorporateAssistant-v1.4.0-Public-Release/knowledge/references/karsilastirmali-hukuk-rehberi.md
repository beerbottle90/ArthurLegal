...
| **e-qanun** 🆕 | self-host `/mcp` | Yok | AZ mevzuatı + yürürlük statüsü — **BİRİNCİL (AZ)** | `eqanun-mcp-rehberi.md` |
| **LexScholar** 🆕 | self-host `/mcp` | Yok | 10 indeks hukuk doktrini (DergiPark dâhil) — **İKİNCİL** | `lex-scholar-rehberi.md` |
| **ResourceContracts** 🆕 | self-host `/mcp` | Yok | İmzalı PSA/JOA emsali — **EMSAL/BENCHMARK** | `resourcecontracts-rehberi.md` |

> 🆕 = v1.4.0 ile eklendi. Üç yeni sunucu **self-hosted ve auth'suz**; host
> geçici bir tünelse (`*.trycloudflare.com`) her yeniden başlatmada değişir —
> bağlantı koparsa önce host'u yenile, sonra ilgili rehberin yedek yoluna düş.
>
