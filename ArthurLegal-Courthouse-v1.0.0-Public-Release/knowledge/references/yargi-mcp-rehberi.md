...
1. **Emsal/içtihat araştırması** (gerekçe/karar yazımı için) → Yargı MCP birinci kaynak; atıf daima verbatim.
...
Her araştırma — **kanun metni (Mevzuat MCP) + yargı yorumu (Yargı MCP)** birlikte değerlendirilmeli; sonuç ve takdir **hâkim/heyettedir**.
