...
15. **Müvekkil verisi**:
    ...
    - Kod adı kullanımı — `[Müvekkil-Tip]` formunda (örn. `[KOBİ Üretici]`, `[Bireysel Davacı]`)
...
Yargı MCP connector etkin. 15 kurumda 24 araç:

- `mcp__claude_ai_Yargi_MCP__search_yargitay_decisions` — Yargıtay (52 daire filtresi)
- `mcp__claude_ai_Yargi_MCP__search_danistay_decisions` — Danıştay (27 daire — vergi: 3/4/7/9)
- `mcp__claude_ai_Yargi_MCP__search_anayasa_bireysel_basvuru` — AYM bireysel başvuru (ceza için kritik)
