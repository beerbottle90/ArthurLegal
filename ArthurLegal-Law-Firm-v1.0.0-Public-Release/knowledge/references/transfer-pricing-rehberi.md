# Transfer Pricing Rehberi — [Yurtdışı Ana Şirket] Intra-Group

> KVK m. 13 + OECD TPG. ArthurLegal Holding'nin ana ortağı Şirket ([Yurtdışı Ana Şirket Merkezi]) ile yaptığı intra-group işlemler Maliye için en hassas alanlardan biri.
...
- **Çifte Vergilendirmeyi Önleme Anlaşmaları** — Türkiye 80+ ülkeyle (örn. [Yabancı Ana Ortak Ülkesi] için ayrıca ÇVÖA varsa kullanılır)

## şirket-özel TP haritası

### Ham petrol alımı ([Yurtdışı Ana Şirket] → [Rafineri Tesisi])
...
- **Şirket brand royalty** — BEPS Action 8 (intangibles) hassas
...
→ Bu **Şirket ([Yurtdışı Ana Şirket Merkezi]) ana şirket tarafından hazırlanır** ([Yabancı Ana Ortak Ülkesi]'da merkezdir).

### Local File
- ArthurLegal Holding spesifik
- İlişkili işlemler envanteri
- Her işlem için yöntem + emsal analizi + fonksiyonel analiz
- Karşı taraf bilgileri

→ Türkiye'de ArthurLegal Holding + Büyük 4 firma birlikte hazırlar.

### CbCR (Country-by-Country Reporting)
- Konsolide grup ana şirket ([Yurtdışı Ana Şirket]) hazırlar
- Türkiye yetkilisi: GİB (Yetkili Otorite — Türkiye-[Yabancı Ana Ortak Ülkesi] arası bilgi paylaşımı)
...
6. **Loss-making entity:** ArthurLegal Holding sürekli zarar ediyorsa intra-group fiyat sorgulanır

## Savunma araçları

- **APA (Advanced Pricing Agreement)** — Maliye ile peşin fiyat anlaşması. Türkiye'de süreç yavaş ama uygun.
- **MAP (Mutual Agreement Procedure)** — Çifte vergilendirme yaşandıysa, Türkiye-[Yabancı Ana Ortak Ülkesi] yetkili makamlar görüşmesi.
- **Cost contribution arrangements** — Ortak fayda projeleri için (R&D, IT)
- **Cost sharing agreement** — Maliyet bölüşüm

## Yargı MCP — TP içtihatı
...
- Şirket profili → tax-legal (bu plugin)
