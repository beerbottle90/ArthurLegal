...
## ArthurLegal Holding için özel örnek senaryolar

### Örnek 1: Ham petrol ithalat sözleşmesi ([Yurtdışı Ana Şirket] → [Rafineri Tesisi])

**Senaryo:** ArthurLegal Holding A.Ş. ([Rafineri Tesisi] adına), yurt dışındaki bir tedarikçiden 200M USD'lik ham petrol alıyor (1 yıllık çerçeve).
...
### Örnek 2: [Halka Açık İştirak] → AB müşteri petrokimya satışı

**Senaryo:** [Halka Açık İştirak], Almanya'da BASF'a 50M EUR'luk etilen satışı (yıllık çerçeve).

**Damga:**
- Sözleşme TR'de mi düzenleniyor? Genelde EVET ([Halka Açık İştirak] Türk şirketi)
...
**Pratik:** [Halka Açık İştirak] için kontrat strüktürü kritik — uzun yıllık çerçeve sözleşme yerine **bireysel sipariş bazlı** çalışma damga matrahını ürün-bazlı küçük tutarlara böler.

### Örnek 3: [Üretim Sahası] Özel Endüstri Bölgesi (ÖEB) — vendor sözleşmesi

**Senaryo:** [Halka Açık İştirak], [Üretim Sahası] ÖEB'de bir bakım hizmeti vendor'ı ile 5M TL'lik sözleşme.
...
### Örnek 4: [Elektrik İştiraki] elektrik üretim — gün öncesi piyasası (EPİAŞ)

**Senaryo:** [Elektrik İştiraki], EPİAŞ üzerinden günlük elektrik satışı yapıyor. Sözleşme yapısı: çerçeve EPİAŞ üyelik + günlük teklifler.
...
**Şirket pratiği:** Kurumsal e-imza için KEP kullanılıyor (TTK 18/3). KEP imzalı sözleşme:
...
## Şirket için damga vergisi karar matrisi
