# Bilirkişilik + Uzman Görüşü Rejimi — Pratik Rehber

> **Durum:** ✅ Açık erişim — API anahtarı gerekmez. Mevzuat (6754 / HMK / CMK) **ArthurLegal MCP (`tr_`)** ile, içtihat **ArthurLegal MCP (`tr_`)** ile çekilir. Bu rehber **expert-opinion** plugin'ini (`bilirkisi-raporu`, `uzman-mutalaasi` skill'leri) destekler. **Asıl kullanım** = karşı taraf/mahkeme bilirkişi raporuna **İTİRAZ** + müvekkil lehine **uzman görüşü (mütalaa)** ürettirme.

İki ayrı kurumu birbirinden net ayırır:
- **Bilirkişi** = mahkemenin atadığı, tarafsız, özel/teknik bilgi sağlayan kişi (HMK m. 266 vd. / CMK m. 62 vd. / 6754 s. Kanun). Mahkeme delili.
- **Uzman görüşü** = tarafın kendi seçtiği uzmandan aldığı bilimsel mütalaa (HMK m. 293). **Taraf delili.**
...
| Kaynak | Kapsam |
|---|---|
| **6754 sayılı Bilirkişilik Kanunu** (RG 24.11.2016/29898) | Bilirkişilik teşkilatı, sicil, eğitim, etik, denetim |
| **Bilirkişilik Yönetmeliği** (RG 03.08.2017/30143) | Uygulama usulü, sicil/liste, eğitim, rapor standartları |
| **HMK m. 266-287** | Medeni yargıda bilirkişi incelemesi |
| **HMK m. 293** | **Uzman görüşü** (taraf delili — bilirkişiden ayrı kurum) |
| **CMK m. 62-73** | Ceza yargısında bilirkişi |
| **Yıllık Bilirkişilik Ücret Tarifesi** | BDB tarafından her yıl RG'de yayımlanır |
...
## 2. KRİTİK İLKE — Bilirkişiye ne zaman gidilir, ne zaman gidilmez
...
**İtiraz/temyiz argümanı (sık kullanılacak):** "Bilirkişi raporu, hukuki nitelendirmeye girerek hakimin görev alanına müdahale etmiştir; HMK m. 266 ihlali — rapor hükme esas alınamaz." → Yargıtay bozma sebebidir.

---

## 3. HMK bilirkişi incelemesi (m. 266-287) — madde haritası
...
2. **İtiraz süresi: tebliğden itibaren 2 HAFTA** (HMK m. 281/1).
3. İtiraz üzerine mahkeme:
   - (a) Eksik/belirsiz noktalarda **aynı bilirkişiden EK RAPOR** ister, veya
   - (b) Gerekirse **YENİ BİLİRKİŞİ** (yeni heyet) görevlendirir.
4. **m. 282:** Hakim raporu serbestçe değerlendirir — **rapor hakimi bağlamaz**; aksi yönde uzman görüşü + itiraz güçlüyse hakim rapora uymayabilir.

---

## 4. CMK bilirkişi (m. 62-73) — özet
...
## 5. HMK m. 293 — UZMAN GÖRÜŞÜ (taraf delili) ⭐⭐

Tarafın **kendi seçtiği uzmandan** aldığı **bilimsel mütalaa**. Bilirkişiden köklü farkı vardır.

| Kriter | Bilirkişi (m. 266 vd.) | Uzman görüşü (m. 293) |
|---|---|---|
| **Kim seçer** | Mahkeme | **Taraf** |
| **Niteliği** | Mahkeme delili / tarafsız | **Taraf delili** (taraf lehine) |
| **Ücreti kim öder** | Yargılama gideri (kural davayı kaybeden) | **Mütalaayı alan TARAF kendi öder** |
| **Ne zaman sunulur** | Mahkemenin atadığı zaman | **Yargılamanın HER aşamasında** sunulabilir (dava/cevap dilekçesiyle, bilirkişi raporuna itirazla, istinaf/temyizde) |
...
## 6. Bilirkişi raporu yapısı (standart — `bilirkisi-raporu` skill çıktısı)

1. **Başlık / dosya bilgisi** — mahkeme, esas no, taraflar, görevlendirme tarihi.
2. **Görevlendirme konusu** — mahkemenin sorduğu sorular (m. 273 karardaki görev sınırı).
3. **İnceleme konusu ve yöntem** — dosya kapsamı, incelenen belgeler, keşif/ölçüm, uygulanan teknik yöntem.
4. **Tespitler (maddi/teknik)** — gözlem, ölçüm, hesap; **hukuki yorum YOK**.
5. **Değerlendirme / hesaplama** — teknik gerekçeli analiz, tablolar.
6. **Sonuç** — her soruya net cevap; **görev sınırı içinde**, hukuki nitelendirmeye girmeden.
...
## 7. Bilirkişi raporuna İTİRAZ dilekçesi yapısı (m. 281 — ana kullanım) ⭐
...
4. **Karşı delil — uzman görüşü:** "Ekte sunulan **HMK m. 293 uzman mütalaası**, raporun X-Y-Z bulgularını çürütmektedir."
5. **Talep:** Öncelikle **ek rapor** (aynı bilirkişiden), kabul edilmezse **yeni bilirkişi/heyet** görevlendirilmesi (m. 281/1); rapora itibar edilmemesi (m. 282).
6. **Tarih + vekil imza.**
...
2. **Müvekkil lehine UZMAN GÖRÜŞÜ (m. 293 mütalaası) ürettirme:** Bağımsız mühendislik/finans uzmanından bilimsel mütalaa aldırıp aleyhe bilirkişi raporunu çürütmek; her aşamada (dava, itiraz, istinaf/temyiz) sunulabilir.

### Tipik uyuşmazlık tipleri
- **EPC / yapım sözleşmesi:** gecikme analizi (delay), iş artışı/azalışı, hak ediş, tasfiye hesabı.
- **Enerji üretim:** türbin performans garantisi, üretim kaybı, kapasite faktörü hesabı.
- **Tedarik/ekipman:** ayıp, uygunsuzluk, değer kaybı.
- **İSG/çevre davaları:** kusur dağılımı için teknik bilirkişi (kusurun **hukuki** sonucu hakime ait — m. 266 itiraz noktası).

### Üretim sırasında zorunlu uyarı
> Bilirkişi raporu / uzman mütalaası **teslimi** yüksek riskli aksiyondur → **avukat / Baş Hukuk Müşaviri onayı şart** ibaresini çıktıya ekle (SYSTEM_PROMPT yüksek-risk listesi).

---

## 10. ArthurLegal MCP (`tr_`) ile çekme

```
# 6754 Bilirkişilik Kanunu
tr_mevzuat_ara(number="6754", types=["KANUN"])
# HMK bilirkişi + uzman görüşü
tr_mevzuat_ara(number="6100", types=["KANUN"])
tr_mevzuat_icinde_ara(mevzuat_id=<HMK id>, query="bilirkişi")     # m. 266-287
tr_mevzuat_icinde_ara(mevzuat_id=<HMK id>, query="uzman görüşü")  # m. 293
# CMK bilirkişi
tr_mevzuat_ara(number="5271", types=["KANUN"])
tr_mevzuat_icinde_ara(mevzuat_id=<CMK id>, query="bilirkişi")     # m. 62-73
# Bilirkişilik Yönetmeliği / Ücret Tarifesi
tr_mevzuat_ara(query="Bilirkişilik Yönetmeliği", types=["YONETMELIK"])
tr_mevzuat_ara(query="Bilirkişilik Ücret Tarifesi")
```

Atıf: `[ArthurLegal TR — 6754 s. K. m. XX / HMK m. XXX — GG.AA.YYYY]`
...
tr_ictihat_ara(
  ...
  query="+bilirkişi +raporu +hukuki +nitelendirme +HMK +266 +görev +sınırı",
  chamber="HGK",
  date_from="2022-01-01"
)
# Rapora itiraz / ek rapor / m. 281
tr_ictihat_ara(
  query="+bilirkişi +raporuna +itiraz +ek +rapor +yeni +bilirkişi +HMK +281",
  date_from="2022-01-01"
)
# Uzman görüşü m. 293
tr_ictihat_ara(
  query="+uzman +görüşü +HMK +293 +taraf +delili +bilimsel +mütalaa",
  date_from="2022-01-01"
)
```
...
- ❌ İtiraz süresini kaçırmak — **rapor tebliğinden 2 hafta** (HMK m. 281). Süreyi tebliğ tarihinden hesapla.
- ❌ Bilirkişiyi **hakim yerine koymak** — raporu mutlak sanmak. **m. 282: rapor bağlamaz**, hakim serbestçe takdir eder.
...
- [ArthurLegal MCP TR rehberi](yargi-mcp-rehberi.md) — içtihat çekme pattern'ları
