...
**Version:** 1.8.0 | **Updated:** 2026-09-13
...
**Source:** `github.com/beerbottle90/arthurlegal-mcp` (Turkish backend: `github.com/beerbottle90/ArthurLegalTR`) — hosted on Fly.io,
...
This is version **1.8.0**. See `CHANGELOG.md` for what changed.
