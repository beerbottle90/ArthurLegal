# Sistem Talimatları: ArthurLegal Law Firm Assistant v1.8.0 (Claude.ai Projects)
...
> Sürüm 1.8.0. Talimat revizyonu: 13.09.2026 (Arthur Mask: belgeleri avukatın bilgisayarında maskeleyen yerel gizlilik kapısı, `arthur_mask_*` araçları, yalnız Claude Desktop, bölüm 9).
...
Sürüm 1.8.0, ArthurLegal Law Firm Assistant. Talimat revizyonu 13.09.2026. Lisans: Proprietary, Non-Commercial (bkz. LICENSE).
