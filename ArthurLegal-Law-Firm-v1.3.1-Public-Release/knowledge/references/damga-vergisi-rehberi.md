...
### Örnek 1: Ham petrol ithalat sözleşmesi ([Ana ortak / ilişkili taraf] → STAR Rafineri)

**Senaryo:** [Müvekkil] (STAR adına), [Grup şirketi] Cenevre'den 200M USD'lik ham petrol alıyor (1 yıllık çerçeve).
...
### Örnek 2: Petkim → AB müşteri petrokimya satışı

**Senaryo:** Petkim, Almanya'da BASF'a 50M EUR'luk etilen satışı (yıllık çerçeve).

**Damga:**
- Sözleşme TR'de mi düzenleniyor? Genelde EVET (Petkim Türk şirketi)
...
**Pratik:** Petkim için kontrat strüktürü kritik — uzun yıllık çerçeve sözleşme yerine **bireysel sipariş bazlı** çalışma damga matrahını ürün-bazlı küçük tutarlara böler.

### Örnek 3: Aliağa Özel Endüstri Bölgesi (ÖEB) — vendor sözleşmesi

**Senaryo:** Petkim, Aliağa ÖEB'de bir bakım hizmeti vendor'ı ile 5M TL'lik sözleşme.
...
### Örnek 4: İÇAN elektrik üretim — gün öncesi piyasası (EPİAŞ)

**Senaryo:** İÇAN, EPİAŞ üzerinden günlük elektrik satışı yapıyor. Sözleşme yapısı: çerçeve EPİAŞ üyelik + günlük teklifler.
