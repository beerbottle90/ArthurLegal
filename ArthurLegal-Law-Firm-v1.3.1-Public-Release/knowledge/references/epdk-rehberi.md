...
> [Müvekkil] Türkiye için günlük operasyonel düzenleyici. [RAFİNERİ] (petrol piyasası), [HALKA AÇIK İŞTİRAK] (petrokimya), [ELEKTRİK ÜRETİM İŞTİRAKİ] (elektrik üretim), eski [DOĞALGAZ DAĞITIM ŞİRKETİ-1]/[DOĞALGAZ DAĞITIM ŞİRKETİ-2] (doğal gaz dağıtım) — hepsi EPDK lisans + tebliğ kapsamında.

## Hukuki çerçeve

| Kanun | Sektör |
|---|---|
| **5015 Petrol Piyasası Kanunu** | Rafineri, akaryakıt — [RAFİNERİ] + [Müvekkil] Enerji Ticaret |
| **4646 Doğal Gaz Piyasası Kanunu** | Doğal gaz dağıtım (eski [DOĞALGAZ DAĞITIM ŞİRKETİ-1]/[DOĞALGAZ DAĞITIM ŞİRKETİ-2]) + iletim ([BORU HATTI PROJESİ]) + ticaret |
| **6446 Elektrik Piyasası Kanunu** | Elektrik üretim — **[ELEKTRİK ÜRETİM İŞTİRAKİ]** + [HALKA AÇIK İŞTİRAK] RES |
...
| Doğal gaz dağıtım | Eski [DOĞALGAZ DAĞITIM ŞİRKETİ-1]/[DOĞALGAZ DAĞITIM ŞİRKETİ-2] (devir) |
...
### Eski [DOĞALGAZ DAĞITIM ŞİRKETİ-1]/[DOĞALGAZ DAĞITIM ŞİRKETİ-2]
...
- [[Müvekkil] [HALKA AÇIK İŞTİRAK] KAP rehberi](sirket-istirak-kap-rehberi.md)
