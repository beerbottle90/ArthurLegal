...
> **[Müvekkil] bağlamı:** TANAP AB bağlantısı, GDPR, AB yaptırım rejimleri, enerji direktifleri
...
| EU ETS | `32003L0087` | Emisyon ticaret sistemi (STAR Rafineri) |
| 3. Enerji Paketi — Gaz | `32009L0073` | TANAP'a uygulanabilir AB gaz direktifi |
| 3. Enerji Paketi — Elektrik | `32009L0072` | İÇAN için AB elektrik direktifi |
| Gaz Güvenliği Yönetmeliği | `32017R1938` | Tedarik güvenliği (TANAP güzergâhı) |
