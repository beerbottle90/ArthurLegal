# ÇED (Çevresel Etki Değerlendirmesi) Rehberi — Aliağa Bağlamı

> 2872 sayılı Çevre Kanunu + ÇED Yönetmeliği. Aliağa rafineri/petkim kompleksinin sürekli ÇED yenileme/değişiklik süreci yakıcı stres alanı.
...
| Tip | Kapsam | [Müvekkil] örneği |
|---|---|---|
| **ÇED gereklilik var/yok** | Ön inceleme | Yeni proje başlangıç |
| **ÇED olumlu/olumsuz** | Tam ÇED süreci | STAR kapasite artırımı, yeni Petkim hattı |
| **Proje tanıtım dosyası (PTD)** | Küçük etkili proje | Tank, ek depo |
| **ÇED muafiyeti** | Listede yok ise | — |
| **Kümülatif etki değerlendirmesi** | Birden fazla proje birlikte | Aliağa ÖEB içi yeni yatırımlar |
...
## Büyük endüstriyel tesis için özel durumlar

### Sürekli ÇED dosyaları
- **STAR Rafineri:** Kapasite artırımı, yeni ünite eklemesi
- **Petkim:** Yeni petrokimya hattı (etilen, propilen genişleme)
- **[müvekkil terminali]:** Kapasite genişleme, yeni rıhtım
- **[müvekkil depolama tesisi]:** Yeni tank, yeni boru hattı
- **Aliağa ÖEB ortak altyapı:** Yol, su, atık su

### Risk faktörleri
- **STK + yerel toplum** baskısı (basın etkili)
- **Bakanlık komisyon değerlendirmesi** öznel
- **Halk katılımı toplantısında** ihtilaf
- **Kümülatif etki** — Aliağa ÖEB içinde tek tek projelerin değerlendirmesi ama toplamda büyük etki
...
- [İSG dava rehberi](isg-dava-rehberi.md) — Aliağa İSG ile koordineli
- Büro profili → administrative-legal
