...
- /energy-finance:cold-start-interview (57 satir)
- /energy-finance:jv-agreement-review (91 satir)
- /energy-finance:lng-offtake-review (107 satir)
- /energy-finance:ma-diligence-energy (106 satir)
- /energy-finance:project-finance-review (106 satir)
...
|---|---|
| **bu plugin icin birincil kullanim** — PSA/JOA, cost recovery, profit split, stabilizasyon, DMO, decommissioning, yerel icerik benchmark'i | `/legal-research:sozlesme-emsali` |
...
- Finansman hukuku ana büro + İstanbul ofisi bağlantısı
...
### Onay ve eskalasyon
- Hangi eşikte CLCO devreye giriyor?
- SPK/EPDK bildirim tetikleyici eşiği
- Kamu açıklaması (KAP) tetikleyici
...
description: >
  ...
  EPDK lisans uyumu ve [ANA ORTAK] intra-group özel dikkat noktaları.
...
| Taraflar + hisse oranları | [ŞİRKET ADI] TR: % / Karşı taraf: % |
| Governing law | [belirle] |
| Tahkim | |
| JV amacı ve süresi | |
| Karşı taraf ülkesi | [[ANA ORTAK]? Alman? Japon?] |

## Adım 2 — Yönetim yapısı & kilit karar mekanizmaları

- **Board kompozisyonu:** [ŞİRKET ADI] atama hakkı, veto hakları
- **Süper çoğunluk kararlar:** neler var, eşik nedir?
- **Deadlock mekanizması:** Russian roulette / Texas shoot-out / mediasyon / fesih
- **CEO/CFO atama:** [ŞİRKET ADI] belirliyor mu, müşterek mi?
...
- [ŞİRKET ADI] TR'nin mevcut enerji portföyü ile örtüşme riski?
...
- SPK/KAP: [HALKA AÇIK İŞTİRAK] ilişkili tarafsa — önemli işlem bildirimi eşiği

## Adım 6 — [ANA ORTAK] intra-group özel dikkat

Karşı taraf [ANA ORTAK] veya bağlı kuruluş ise:
- Transfer fiyatlandırması (TP) riski — KVK m.13
- CAATSA yaptırım riski (Rusya bağlantılı JV ise)
- Azerbaycan kurumsal yönetim gereksinimleri
- Döviz kontrol kuralları (AZN/USD)
...
description: >
  ...
  alıcı özel dikkat noktaları. [ŞİRKET ADI] TR satın alma veya satış tarafı için kalibre.
...
| [ŞİRKET ADI] tarafı | Alıcı (buyer) / Satıcı (seller) |
...
- **Downward quantity tolerance (DQT):** [ŞİRKET ADI] satıcıysa, teslimat esnekliği
...
- **Cap / floor:** var mı?
- **Döviz:** USD / EUR — kur riski [ŞİRKET ADI]'da mı?
...
- FM tanımı kapsamı: doğal afet / siyasi / COVID benzeri pandemi / siber
- **Yaptırım (sanctions) FM:** OFAC/AB/BM yaptırım listesine giriş FM sayılıyor mu?
- **[ANA ORTAK] açısından:** Rusya bağlantılı FM senaryoları — CAATSA m.232 riski
...
## Özel notlar (Japon/Koreli alıcı, [ANA ORTAK])
...
description: >
  ...
  iş güvenliği sicil, rekabet eşiği ve SPK bildirim kontrolü içerir. [ŞİRKET ADI] TR
  enerji varlık devralma işlemlerine kalibre.
...
- ArthurLegal MCP (`tr_`): `kurum_karari_ara (kurum="rekabet")` (enerji piyasası) çek
...
2. Türk ortaklar: MKK / VERBİS teyit
3. Azerbaycanlı veya CIS ortak: CAATSA m.232 riski değerlendirmesi
4. Yaptırım eşleşmesi → [UYUM DİREKTÖRÜ]'e eskalasyon, işleme devam etme

## Adım 3 — Vergi durum tespiti

- Vergi borcunun tespiti: Gelir İdaresi GİB sorgusu (ArthurLegal MCP (`tr_`): `kurum_karari_ara (kurum="gib")`)
...
- 200+ yabancı çalışan varsa çalışma izni uyumu
...
description: >
  ...
  package, conditions precedent checklist, lender's due diligence. [RAFİNERİ]/[HALKA AÇIK İŞTİRAK] ölçeği.
...
- **Borçlu yapısı:** SPV mi, doğrudan [ŞİRKET ADI] TR mi, JV şirketi mi?
- **Borç/öz kaynak oranı:** D/E ratio — [ŞİRKET ADI] standart eşiği
...
- KAP bildirimi ([HALKA AÇIK İŞTİRAK] SPK yükümlülüğü) tamamlandı mı?
...
- **Cross-default / cross-acceleration** — diğer [ŞİRKET ADI] TR borç belgelerini etkiler mi?
...
- Kefalet: [ŞİRKET ADI] TR garantisi — recourse seviyesi nedir?
